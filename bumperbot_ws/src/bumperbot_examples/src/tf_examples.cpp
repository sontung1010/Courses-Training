...
TfExamples::TfExamples(const ros::NodeHandle &nh) : nh_(nh), x_increment_(0.05), last_x_(0.0), tf_listener_(tf_buffer_), rotations_counter_(0) {
    ...
    ROS_INFO_STREAM("Publishing static transform between " << static_transform_stamped_.header.frame_id << " and " << static_transform_stamped_.child_frame_id);
