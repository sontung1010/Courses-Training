...
#--------------------------- GCC -----------------------
GCC_TARGET_CC_OPTS      = -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O1 -g -gstrict-dwarf -DRT -DmwSize=size_t -include stdbool.h -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
...
ADD_INCLUDES = \
	...
	-$(include_opt)$(START_DIR)\twofourbit_adder_mbd_rtw \
...
clean:
	...
	@if exist *.dep  $(RM) *.dep
	@if exist *.inf  $(RM) *.inf
	@findstr /V /C:"#include <cstring>" $(MODEL).h > $(MODEL).h.fixed
	@findstr /V /C:"#include <cstring>" $(MODEL).h.fixed > $(MODEL).h
