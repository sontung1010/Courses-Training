...
#ifndef RTW_HEADER_slow_h_
#define RTW_HEADER_slow_h_
...
/* Block states (default storage) for system '<Root>/Subsystem1' */
typedef struct {
...
extern void slow_Init(RT_MODEL_two_virtual_wheel_au_T * const
                      two_virtual_wheel_autocode_M, DW_slow_T *localDW);
extern void slow(RT_MODEL_two_virtual_wheel_au_T * const
                 two_virtual_wheel_autocode_M, real32_T rtu_In1, real32_T
                 *rty_Out1, DW_slow_T *localDW);

#endif                                 /* RTW_HEADER_slow_h_ */
